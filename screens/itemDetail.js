...
const ItemDetail = ({ route, navigation }) => {
    ...
    function fillArray() {
        ...
        if (itemDetail.image1 !== null)
            tmp.push(itemDetail.image1)

        if (itemDetail.image2 !== null)
            tmp.push(itemDetail.image2)

        if (itemDetail.image3 !== null)
            tmp.push(itemDetail.image3)

        if (itemDetail.image4 !== null)
            tmp.push(itemDetail.image4)

        if (itemDetail.image5 !== null)
            tmp.push(itemDetail.image5)
    ...
    useEffect(() => {
        ...
        axios.get(`http://192.168.1.108:8080/api/Employees/${itemDetail.employee}`).then((res) => {
            if (res.data) {
                fillArray()
    ...
    const renderItem = ({ item, index }) => {
        return (
            ...
            >
                <Image
                    source={{ uri: `http://192.168.1.108:8080/uploads/${item}` }}
                    resizeMode="cover"
                    style={{
                        width: 150,
                        height: 100,
            ...
            {!isLoading && (
                <>
                    ...
                    >
                        ...
                        <ImageBackground
                            source={{ uri: `http://192.168.1.108:8080/uploads/${itemDetail.image1}` }}
                            resizeMode="cover"
                            style={{
                                width: "100%",
                                height: 180,
                        ...
                        <Image
                            source={{ uri: `http://192.168.1.108:8080/uploads/${employee.image}`}}
                            resizeMode="cover"
                            style={{
                                height: 90,
                                width: 90,
                        ...
                        >
                            ...
                            >
                                ...
                                <Button text="Send demand" bgColor={COLORS.skyBlue} onPress={() => { navigation.push("sendDemand",{employee} ) }} />
                            </View>

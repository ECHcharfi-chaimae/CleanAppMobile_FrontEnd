...
import DemandClient from '../components/DemandClient'
import DemandEmployee from '../components/DemandEmployee';
...
const ListDemandsClient = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    if (phoneNumber !== null) {
      ...
      axios.get('http://192.168.1.108:8080/api/client/demands/' + phone)
        .then(response => {

...
function ServiceOffer({ item, services, navigation, filter }) {


    const [addedToFavorite, setAddedToFavorite] = useState(false); // hadi makhsaxi d bqa false khs n jibu m local  storage !!!!!
    ...
    const favorite = () => {
        ...
        //save item kamel !! f local storage !
    }
    ...
    useEffect(() => {
        console.log("addedToFavoriteHelp => " + JSON.stringify(addedToFavoriteHelp))

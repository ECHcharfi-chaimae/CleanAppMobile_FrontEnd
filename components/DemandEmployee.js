...
function DemandEmployee({ item, Services, setShowModal, setSelectedItem }) {
    ...
    const changeDemandState = (id, statut) => {
        ...
        axios.put(`http://192.168.1.108:8080/api/demande/update/${id}`, test).then(res => {
        }).catch(err => {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.1.108:8080/api/services/' + item.service)
            .then(response => {
        ...
        axios.get('http://192.168.1.108:8080/api/Employees/' + item.employee)
            .then(response => {
